 ...
 *
 */
public class ReturnAddedRewardsTask extends CommonProcessTask {
	...
	public List<AddedRewardsTaskForm> listByAssignee(String assignee) {
		...
		List<Task> userTaskList = taskService.createTaskQuery().processDefinitionKey("addedRewardsProcess").taskDefinitionKey("returnAddedRewardsTask").taskAssignee(assignee).list();
